  ...
  useControls({
    ...
    'First': folder({
      ...
      randomDrift1: {
        ...
        min: -30,
        max: 30,
        render: (get) => get('enableRandomDrift1'),
    ...
    'Second': folder({
      ...
      randomDrift2: {
        ...
        min: -30,
        max: 30,
        render: (get) => get('enableRandomDrift2'),
    ...
    'Third': folder({
      ...
      randomDrift3: {
        ...
        min: -30,
        max: 30,
        render: (get) => get('enableRandomDrift3'),
